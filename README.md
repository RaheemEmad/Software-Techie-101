...
| | | |
|---|---|---|
| [🎯 Career](#career) | [🌐 Web Dev](#web-dev) | [🛠️ General Dev](#general-dev) |
| [🧩 Problem Solving](#problem-solving) | [🧠 Self-Improvement](#self-improvement) | [📚 Books](#books) |
| [🎙️ Podcasts](#podcasts) | [💼 Interview Prep](#interview-prep) | [📄 CV & Resume](#cv-resume) |
...
- [Total pay estimates for a Frontend Developer Junior in Egypt](https://www.glassdoor.com/Salaries/egypt-junior-frontend-developer-salary-SRCH_IL.0,5_IN69_KO6,31.htm)
...
<details>
<summary>37 links (videos, reading, repos) — click to expand</summary>
...
- [ES6 Tutorial: Modern JavaScript for Beginners](https://www.youtube.com/watch?v=w3ZwgdgCigM&t=204s)
- [Primitive Types vs Reference Types, Part 1](https://youtu.be/hnsA0Y5MHDE)
- [Primitive Types vs Reference Types, Part 2](https://www.youtube.com/watch?v=U_WwLiTKM7I)
...
- [OCR GCSE (J277) Specification Order](https://www.youtube.com/playlist?list=PLCiOXwirraUAEhj4TUjMxYm4593B2dUPF)
- [OCR GCSE Computer Science: Computer Systems (Paper 1)](https://www.youtube.com/playlist?list=PL04uZ7242_M60Z2F8qV7sId99cuwV_Z3T)
- [OCR GCSE Computer Science: Computational Thinking, Algorithms and Programming (Paper 2)](https://www.youtube.com/playlist?list=PL04uZ7242_M5KsKU1axzQ20dl4ZvYHPZn)

**Reading**
- [Becoming a JS EventListener Master While Traveling In The DOM Desert](https://levelup.gitconnected.com/becoming-a-js-eventlistener-master-while-traveling-in-the-dom-desert-e6f93226064e)
- [Trendy JavaScript Projects](https://www.crio.do/blog/fresh-and-trendy-javascript-projects-for-beginners/)
...
- [What is Callback Hell, and how/why does Rx solve it](https://stackoverflow.com/questions/25098066/what-is-callback-hell-and-how-and-why-does-rx-solve-it)
- [What is jQuery](https://code.tutsplus.com/tutorials/what-is-jquery--cms-26232)
- [Visualizing Memory Management in the V8 Engine](https://deepu.tech/memory-management-in-v8/)
...
- [typeof Array is "object" in JavaScript](https://dev.to/pestrinmarco/typeof-array-is-an-object-in-javascript-1p6k)
...
<details>
<summary>23 links (videos, reading, courses, roadmap) — click to expand</summary>
...
- [Redux](https://www.youtube.com/watch?v=w9ghRG9Foiw)
...
**Reading**
- [Understanding React.js Project Structure and Folder Setups](https://www.xenonstack.com/insights/reactjs-project-structure)
...
- [Junior vs Senior React Folder Structure](https://www.youtube.com/watch?v=UUga4-z7b6s)
...
- [15 React Projects Course (freeCodeCamp)](https://www.freecodecamp.org/)
- [Complete React Developer in 2022 (Udemy)](https://www.udemy.com/course/complete-react-developer-zero-to-mastery/)
...
- [React Fundamentals (Frontend Armory)](https://frontarm.com/courses/react-fundamentals/)
- [kimz codes (YouTube playlists)](https://www.youtube.com/channel/UC-MNF_TXywelItd7M8d-uHA/playlists)
- [CMS Using React (Reactbricks)](https://reactbricks.com/)
- [React Cheatsheet](https://codingcheats.io/react/)

**Roadmap**
- [Master React (roadmap.sh)](https://roadmap.sh/react)
...
<details>
<summary>34 links (reading, tools, videos) — click to expand</summary>

**Reading**
- [How to Report Errors in Forms](https://www.nngroup.com/articles/errors-forms-design-guidelines/)
- [15 Best JavaScript UI Libraries to Build Modern Applications](https://geekflare.com/best-javascript-ui-libraries/)
...
- [12 APIs That You As a Developer Will Love](https://dev.to/monicafidalgo/12-apis-that-you-as-a-developer-will-love-it-4ec6)
...
- [Practical CSS and Design Tips for Future-Proof UIs](https://defensivecss.dev/)
...
- [Jamstack Glossary](https://jamstack.org/glossary/atomic/)

**Videos**
- [Vue Documentary](https://www.youtube.com/watch?v=OrxmtDw4pVI)
- [What is CORS? Cross-Origin Resource Sharing Explained](https://www.youtube.com/watch?v=h-WtIT6gCBk)

</details>

---

<a name="general-dev"></a>
## 🛠️ General Dev & Infra
...
- [What Sets an Exceptional Programmer Apart From an Ordinary Programmer](https://levelup.gitconnected.com/what-sets-an-exceptional-programmer-apart-from-an-ordinary-programmer-73d3fce24e21)
...
- [Go Free Full Course](https://www.karanpratapsingh.com/courses/go)
...
<details>
<summary>18 links — click to expand</summary>

**Notes & Training Repos**
- [Problem-Solving Readme](https://github.com/RaheemAmer/Learn-Programming/blob/main/Problem-solving.md)
- [Arabic Competitive Programming (repo)](https://github.com/mostafa-saad/ArabicCompetitiveProgramming)
...
- [Using JavaScript's Map() Method for BFS and DFS](https://www.freecodecamp.org/news/how-to-use-javascript-map-method-to-make-a-breath-first-and-depth-first-search/amp/)

**Judges & Practice Sites**
...
- [Coderbyte Courses](https://www.coderbyte.com/developers?utm_campaign=NewHomepage#courses)
...
<details>
<summary>15 links — click to expand</summary>
...
- [The Power of Believing That You Can Improve (TED)](https://www.ted.com/talks/carol_dweck_the_power_of_believing_that_you_can_improve)
...
- [How to Break Habits — from The Power of Habit (video)](https://www.youtube.com/watch?v=W1eYrhGeffc&t=218s)
- [The Art of Learning](https://www.joshwaitzkin.com/the-art-of-learning)
- [Geoff Colvin: Talent Is Overrated (talk overview)](https://www.youtube.com/watch?v=1_8SUnwmlX4)
...
- [Epic React Podcast](https://open.spotify.com/show/3vjuOCwZ7kfUgm80xSpZmK?si=4ac8172469c243fe)
...
- [Interview Questions (java5cript)](https://www.java5cript.com/interview-questions)
...
- [11 Advanced React Interview Questions, With Detailed Answers](https://tapajyoti-bose.medium.com/11-advanced-react-interview-questions-you-should-absolutely-know-with-detailed-answers-e306083ecb7d)
...
- [The Trickiest Part of an Effective Technical Interview](https://medium.com/codex/the-best-part-of-effective-technical-interview-82f2d206c0ef)
